...
/**
 * Bean definitions for {@link ReviewRepository}.
 */
@Generated
public class ReviewRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'reviewRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getReviewRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'reviewRepository'.
   */
  public static BeanDefinition getReviewRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ReviewRepository.class, Review.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.csc340.backend_api_team10.repository.ReviewRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ReviewRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.csc340.backend_api_team10.repository.ReviewRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getReviewRepositoryInstanceSupplier();
