...
import com.csc340.backend_api_team10.entity.Customer;
...
public class CustomerRepository__BeanDefinitions {
  ...
  public static BeanDefinition getCustomerRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.csc340.backend_api_team10.repository.CustomerRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.csc340.backend_api_team10.repository.CustomerRepositoryImpl__AotRepository(entityManager, context));
      }
    });
